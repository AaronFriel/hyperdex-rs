...
Commit the workspace baseline and create dedicated worktrees for alternative
consensus and transport implementations so parallel implementation can proceed
